...
void ExtButton_Led_Interrupt(void)
{
    GPIO_Handle_t GpioLed;
    GPIO_Handle_t GpioBtn;
    ...
    GPIO_WriteToOutputPin(GPIOB, LED1_GREEN, GPIO_PIN_RESET);
    /* IRQ Configurations */
...
void IntButton_Led_Interrupt(void)
{
    GPIO_Handle_t GpioLed;
    GPIO_Handle_t GpioBtn;
    ...
    /* IRQ Configurations */
    GPIO_IRQPriorityConfig(IRQ_NO_EXTI15_10, NVIC_IRQ_PRIO2);
